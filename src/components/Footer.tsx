...
export default function Footer() {
  ...
  return (
    <footer id="contact" className="relative overflow-hidden">
      {/* Background */}
      <div className="absolute inset-0 bg-gradient-to-t from-[var(--bg-tertiary)] via-[var(--bg-secondary)] to-[var(--bg-primary)]" />
      <div className="absolute inset-0 bg-grid opacity-20 dark:opacity-10" />

      {/* Decorative glow */}
      <div className="absolute -bottom-32 left-1/2 -translate-x-1/2 w-[600px] h-[300px] rounded-full bg-gradient-to-t from-[var(--accent-primary)]/15 to-transparent blur-3xl" />
      ...
      <div className="container-custom relative z-10">
        ...
        >
          ...
          >
            <FaEnvelope className="w-4 h-4 text-[var(--accent-primary)]" />
            <span className="text-sm text-[var(--accent-primary)]">Get In Touch</span>
          </motion.div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-10">
            ...
            <div className="md:col-span-5 space-y-6">
              <Link href="/" className="inline-flex items-center space-x-3 group">
                <motion.div className="relative w-12 h-12" whileHover={{ scale: 1.1, rotate: 5 }}>
                ...
                <div>
                  ...
                  <span className="text-sm text-[var(--text-muted)]">Full Stack Developer</span>
                </div>
              </Link>
              ...
              <div className="flex gap-3">
                {socialLinks.map((link, index) => (
                  <motion.a
                    ...
                    className="w-11 h-11 glass-card !rounded-xl flex items-center justify-center text-[var(--text-muted)] hover:text-[var(--text-primary)] hover:!border-[var(--accent-primary)]/30 transition-all duration-300"
            ...
            <div className="md:col-span-3">
              <h3 className="text-lg font-semibold text-[var(--text-primary)] mb-5">Quick Links</h3>
              <ul className="space-y-3">
                {quickLinks.map((link, index) => (
                  ...
                  >
                    <Link
                      href={link.href}
                      className="text-[var(--text-secondary)] hover:text-[var(--text-primary)] transition-colors duration-300 flex items-center gap-2 group"
                    >
                      <span className="w-1.5 h-1.5 rounded-full bg-[var(--accent-primary)] opacity-0 group-hover:opacity-100 transition-opacity" />
                      {link.label}
                    </Link>
                  </motion.li>
                ))}
            ...
            <div className="md:col-span-4">
              ...
              <div className="space-y-4">
                ...
                >
                  <div className="w-10 h-10 glass-card !rounded-lg flex items-center justify-center text-[var(--accent-primary)] group-hover:!bg-[var(--accent-primary)]/10 transition-colors flex-shrink-0">
                    <FaEnvelope />
                  </div>
                  <div>
                ...
                >
                  <div className="w-10 h-10 glass-card !rounded-lg flex items-center justify-center text-[var(--accent-primary)] flex-shrink-0">
