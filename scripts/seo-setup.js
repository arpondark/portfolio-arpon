...
2. 🔍 Add to Google Search Console:
   ...
   - Add property: https://shazan.site
   - Verify ownership using HTML file or DNS

3. 📄 Submit your sitemap:
   - URL: https://shazan.site/sitemap.xml
   - In Search Console: Sitemaps → Add new sitemap

4. 🤖 Check robots.txt:
   - URL: https://shazan.site/robots.txt
...
console.log("\n🔗 Important URLs:");
console.log("- Sitemap: https://shazan.site/sitemap.xml");
console.log("- Robots: https://shazan.site/robots.txt");
console.log("- Blog: https://shazan.site/blog");
console.log("- API Sitemap: https://shazan.site/api/sitemap");
